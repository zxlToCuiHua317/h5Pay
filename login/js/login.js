(function (window, document) {
    function Login(config) {
        ...
        Login.prototype.sendData;
        Object.assign(Login.prototype.config, config)
        localStorage.setItem("config", JSON.stringify(Login.prototype.config))
    }
    ...
    Login.prototype = {
        ...
        init: function (callback) {
            ...
            if (name) {
                ...
                if (ch) {
                    Login.prototype._getMakeLogin(callback);
                }
            }
        ...
        <div class="loading"></div>
            ...
            this._automaticLogin(callback)
        },
        handleClick: function (callback) {
            $(".start_game").click(function () {
                $(".automatic_login_ns").show()
                $(".start_bg").hide()
                Login.prototype._automaticLogin(callback)
            })

            // $(".login_logo_ns").click(function () {
                    ...
                    if (window.confirm("是否要刪除該賬號記錄")) {
                        ...
                        if (getFbLoginData.length === 0) {
                            ...
                            if (getPtLoginData.length > 0 && getTryLoginData.length > 0) {
                                ...
                                arrData = [].concat(Login.prototype._toConsumableArray(getPtLoginData), Login.prototype._toConsumableArray(getTryLoginData));
                                str = "";
                                ...
                                console.log(getPtLoginData);
                                arrData = [].concat(Login.prototype._toConsumableArray(getPtLoginData));
                                str = "";
                                ...
                                console.log(getPtLoginData);
                                arrData = [].concat(Login.prototype._toConsumableArray(getTryLoginData));
                                str = "";
                    ...
                    if (window.confirm("是否要刪除該賬號記錄")) {
                        ...
                        if (getPtLoginData.length === 0) {
                            ...
                            if (getFbLoginData.length > 0 && getTryLoginData.length > 0) {
                                arrData = [].concat(Login.prototype._toConsumableArray(getFbLoginData), Login.prototype._toConsumableArray(getTryLoginData));
                            ...
                            if (getFbLoginData.length > 0 && getPtLoginData && getTryLoginData.length > 0) {
                                str = "";
                                arrData = [].concat(Login.prototype._toConsumableArray(getPtLoginData), Login.prototype._toConsumableArray(getFbLoginData), Login.prototype._toConsumableArray(getTryLoginData));
                                $(".sel-title").text(arrData[0].name);
                                $(".sel-img").removeClass("icon-people").addClass(arrData[0].icon);
                                arrData.forEach(function (item, index) {
                                    str += " <li class=\"item" + index + "\">\n                                    <span class=\"item-img iconfont " + item.icon + "\"></span>\n                                    <span class=\"item-title\">" + item.name + "</span>\n                                    <span class=\"item-down iconfont icon-shanchu\"></span>\n                                </li>";
                                ...
                                str = "";
                                arrData = [].concat(Login.prototype._toConsumableArray(getPtLoginData), Login.prototype._toConsumableArray(getFbLoginData));
                                $(".sel-title").text(arrData[0].name);
                                $(".sel-img").removeClass("icon-people").addClass(arrData[0].icon);
                                arrData.forEach(function (item, index) {
                                    str += " <li class=\"item" + index + "\">\n                                    <span class=\"item-img iconfont " + item.icon + "\"></span>\n                                    <span class=\"item-title\">" + item.name + "</span>\n                                    <span class=\"item-down iconfont icon-shanchu\"></span>\n                                </li>";
                    ...
                    if (window.confirm("是否要刪除該賬號記錄")) {
                        ...
                        if (getTryLoginData.length === 0) {
                            ...
                            if (getPtLoginData.length > 0 && getFbLoginData.length > 0) {
                                ...
                                console.log(getPtLoginData);
                                arrData = [].concat(Login.prototype._toConsumableArray(getFbLoginData));
                                str = "";
                            ...
                            if (arrData[chindex].name === username) {
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        siteCode: "lunplay",
                                        t: "1378215459501",
                                        ck: "ba9d42a6a82e7cea623fa47bf1acc66f",
                                        ismobile: "yes",
                                        ...
                                        if (res.code === "1000") {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function success(res) {
                                                    ...
                                                    localStorage.setItem("ptLoginData", JSON.stringify(getPtLoginData));
                                                    localStorage.setItem("callbackData", JSON.stringify(res))
                                                    $(".main").remove()
                                                    callback(res)
                                                    Login.prototype._sendPx(res.toGameInfo.passport)
                                                }
                                            });
                                        } else {
                                            alert(res.msg);
        ...
        EventClick: function (callback) {
            $(".login_button_ns").click(function () {
                ...
                if (isClick) {
                    Login.prototype._login_mobile(callback)
                }
            });
        ...
        _login_mobile: function (callback) {
                ...
                $.ajax({
                    ...
                    success: function success(res) {
                        ...
                        if (res.code === "1000") {
                            ...
                            ptLoginData = JSON.parse(localStorage.getItem("ptLoginData"))
        ...
        _userRegister: function (callback) {
        ...
        _tryUpgradeAccount: function (callback) {
        ...
        _getMakeLogin: function (callback) {
            $.ajax({
                url: "//gc-nrxws.95vy.com/baseFacebook/login.do",
                type: "POST",
                data: {
                    fbAppID: appid,
                    ...
                    if (res.code === "1000") {
                        $.ajax({
                            ...
                            success: function success(result) {
                                ...
                                if (res.code === "1000") {
                                    Login.prototype._getLogin(accessToken, callback);
                                    var time = new Date().getTime();
                                    fbdata = {
                                        typename: "FackBook",
                                        name: FBName,
        ...
        _getLogin: function (accessToken, callback) {
        ...
        _automaticLogin: function (callback) {
            var getFbLoginData = JSON.parse(localStorage.getItem("fbLoginData"));
            var getPtLoginData = JSON.parse(localStorage.getItem("ptLoginData"));
            var getTryLoginData = JSON.parse(localStorage.getItem("tryLoginData"));
            var arrData = [].concat(Login.prototype._toConsumableArray(getPtLoginData), Login.prototype._toConsumableArray(getFbLoginData), Login.prototype._toConsumableArray(getTryLoginData));
        ...
        //触发fb像素
        _sendPx: function (res) {
            // fbq('track', 'CompleteRegistration');
            // fbq('trackCustom', 'CompleteRegistrationNumber', {
            //     myParam: res
            // });
        },
        //将参数抛出
        _uploadParams: function (res) {
            return new Promise((resolve, reject) => {
                resolve(res)
            })
        },
